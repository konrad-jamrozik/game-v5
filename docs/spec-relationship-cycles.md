...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Mechanics and content                            | Mechanics owns parameter meaning; content owns concrete values. Both directions are currently needed to author a playable campaign.           | Separate shared content schemas/parameter contracts from their concrete catalogs. Mechanics consumes schema-conforming inputs; content conforms to those schemas; composition selects catalogs. Exit when these subjects no longer require mechanics-to-catalog-to-mechanics paths. |
