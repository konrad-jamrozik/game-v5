...
| MODEL  | [Modeling Foundations](../specs/foundation/modeling-foundations.md)       | Draft  | Modeling vocabulary, definitions/content entries/instances, identity and references, and historical preservation | Modeling vocabulary, definition/content entry/instance boundaries, identity/references, and historical preservation. |
