...
| MODEL  | [Modeling Foundations](../specs/foundation/modeling-foundations.md)       | Draft  | Modeling vocabulary, schemas/content entries/campaign instances, identity and references, and historical preservation | Modeling vocabulary, schema/content entry/campaign instance boundaries, construction, identity/references, and historical preservation. |
