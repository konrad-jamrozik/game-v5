...
| MODEL  | [Modeling Foundations](../specs/foundation/modeling-foundations.md)       | Draft  | Types, campaigns, content entries, instance construction and composition, identity and references, and historical preservation | Modeling vocabulary, Types, archetypes, three-component campaign instances, construction, identity/references, and historical preservation. |
