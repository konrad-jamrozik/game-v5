...
| MODEL   | Foundation | [Modeling Foundations](foundation/modeling-foundations.md)                                           | Modeling vocabulary, schema/content entry/campaign instance boundaries, construction, identity/references, and historical preservation. |
