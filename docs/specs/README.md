...
| MODEL   | Foundation | [Modeling Foundations](foundation/modeling-foundations.md)                                           | Modeling vocabulary, TypeScript types, archetypes, three-component campaign instances, construction, identity/references, and historical preservation. |
