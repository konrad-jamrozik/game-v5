...
| MODEL   | Foundation | [Modeling Foundations](foundation/modeling-foundations.md)                                           | Modeling vocabulary, definition/content entry/instance boundaries, identity/references, and historical preservation. |
