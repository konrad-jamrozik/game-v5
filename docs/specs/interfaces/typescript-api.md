...
Campaign instance must use a Campaign instance constructor contract satisfying [MODEL-006](../foundation/modeling-foundations.md#model-006--campaign-instance-construction), with a declared Type for the returned Campaign instance and initialization of Archetype, MutableState, and ImmutableState containing
