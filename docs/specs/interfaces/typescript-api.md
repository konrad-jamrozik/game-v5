...
campaign instance must use a constructor contract satisfying [MODEL-006](../foundation/modeling-foundations.md#model-006--campaign-instance-construction), with a declared result Type and initialization of Archetype, MutableState, and ImmutableState containing
