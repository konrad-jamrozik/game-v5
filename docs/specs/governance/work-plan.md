...
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| 1     | [Domain Model](../foundation/domain-model.md); [Modeling Foundations](../foundation/modeling-foundations.md); [Engine Contract](../foundation/engine-contract.md) | Agree on vocabulary, entities, instances, content entries, relationships, authoritative state, and boundaries before specifying behavior. Review the three drafts as one batch. | In review  |
